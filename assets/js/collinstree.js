     ...
     "children": [
       ...
       {"name": "May Allen",
        ...
        {"name": "Sarah Sheffield",
         ...
         "location": "New York",
         "children": [
          {"name": "Daniel M. Sheffield",
           "birth": "1831",
           "location": "New York"},
          {"name": "Mary Ann Blakely",
           "birth": "1840",
           "location": "New York"}
        ]}
      ]}
...
var svgTree = svgContainer.append("g")
    .attr("transform", "translate (50,25) scale(.5,.5)");
...
// Set node seperation
tree.separation(function(a, b) { return a.parent === b.parent ? 1 : .75; });
